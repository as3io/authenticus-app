...
import checkSession from 'authenticus-app/gql/queries/check-session';
import deleteSession from 'authenticus-app/gql/mutations/delete-session';
import loginUser from 'authenticus-app/gql/mutations/login-user';
